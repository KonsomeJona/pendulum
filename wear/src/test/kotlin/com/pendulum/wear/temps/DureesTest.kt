...
class DureesTest {
    ...
    fun `le catalogue n'est pas vide`() {
        ...
        assertThat(accesseurs()).hasSizeGreaterThanOrEqualTo(8)
    }
    ...
    fun `le catalogue actif suit la variante compilee`() {
        assertThat(Durees.ACTIVES.rotationChunkMs)
            .isEqualTo(Durees(EchelleTemps.DIVISEUR).rotationChunkMs)
    }
}
