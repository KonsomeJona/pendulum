...
listing is placing it on the market. An application that produces a figure about a sleep disorder about a
...
- Every listing states, in its first lines, what the application is (a measurement tool that produces a
